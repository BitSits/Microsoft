...
COMSCORE.SiteRecruit.Broker.config = {
	...
	,{m: '//[\\w\\.-]+/australia/windows/', c: 'inv_c_p15466742-AU-826-p37131508-AU.js', f: 0.5, p: 0 	}
	,{m: '//[\\w\\.-]+/brasil/windows', c: 'inv_c_p37131508-Brazil.js', f: 0, p: 0, halt:true 	}
	...
	,{m: '//[\\w\\.-]+/fr/fr/(default\\.aspx)?$', c: 'inv_c_p15466742-France-HP.js', f: 0.14, p: 0 	}
	,{m: '//[\\w\\.-]+/france/windows/', c: 'inv_c_FR-p15466742_p37131508-Windows.js', f: 0.102, p: 0 	}
	...
	,{m: '//[\\w\\.-]+/japan/athome/', c: 'inv_c_JA-p15466742-athome.js', f: 0.0019, p: 0 	}
	...
	,{m: '//[\\w\\.-]+/japan/windows(/(?!(downloads/ie/au\\.mspx)|(downloads/ie/iedelete\\.mspx))|$)', c: 'inv_c_JA-p15466742-p37131508-windows.js', f: 0.007, p: 0 	}
	,{m: '//[\\w\\.-]+/korea/windows', c: 'inv_c_p37131508-Korea.js', f: 0.0219, p: 0 	}
	,{m: '//[\\w\\.-]+/learning/en/us', c: 'inv_c_3331mt42.js', f: 0.0683, p: 0 	}
	,{m: '//[\\w\\.-]+/licensing(/(?!(servicecenter)|(licensewise/product\\.aspx)|(licensewise/program\\.aspx)|(mla/select\\.aspx)))', c: 'inv_c_3331mt43.js', f: 0.06, p: 0 	}
	...
	,{m: '//[\\w\\.-]+/security', c: 'inv_c_3331mt49.js', f: 0.0036, p: 0 	}
	...
	,{m: '//(sr-www|wwwstaging|www\\.microsoft)[\\w\\.-]+/windows/(?!enterprise)', c: 'inv_c_p25328149-p44121997-652.js', f: 0.00345, p: 0 	}
	,{m: '//[\\w\\.-]+/windows/business/', c: 'inv_c_p53368869-p25328149.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/windows/buy/', c: 'inv_c_p25328149-Buy-WLS-p38104477-BUY-p44121997.js', f: 0.1068, p: 1 	}
	,{m: '//[\\w\\.-]+/windows/compatibility/windows-7/en-us', c: 'inv_c_p43579784-p44121997-p25328149.js', f: 0.0137, p: 2 	}
	,{m: '//[\\w\\.-]+/windows/(default\\.aspx)?$', c: 'inv_c_p25328149-HP_882-p44121997.js', f: 0.0355, p: 1 	}
	,{m: '//[\\w\\.-]+/windows/downloads/', c: 'inv_c_p25328149-downloads-p34934647.js', f: 0.024, p: 1 	}
	...
	,{m: '//[\\w\\.-]+/windows/pc-scout/(default\\.aspx)?$', c: 'inv_c_p25328149-Buy-p44121997.js', f: 0.1355, p: 2 	}
	,{m: '//[\\w\\.-]+/windows/social', c: 'inv_c_p44121997-p25328149-940.js', f: 0.5, p: 1 	}
	,{m: '//[\\w\\.-]+/windows/windows-7/', c: 'inv_c_p34934887-p25328149-p44121997.js', f: 0.004, p: 1 	}
	...
	,{m: '//[\\w\\.-]+/windows/windows-7/what-is-windows-7\\.aspx$', c: 'inv_c_p44121997-p34934887-p25328149-941.js', f: 0.1038, p: 2 	}
