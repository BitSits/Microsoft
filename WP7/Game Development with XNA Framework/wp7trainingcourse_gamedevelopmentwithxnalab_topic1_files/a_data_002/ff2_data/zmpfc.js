...
if(zzNewEsi==true){
document.write('<script language="javascript" src="http://d7.zedo.com/OzoDB/cutils/R52_5/jsc/929//egc.js?&x=1&n='+zce0+'&c='+zcc1+'&a='+zcq2+'&d='+zcr0+'&z='+Math.random()+'"></script>');
}else{
...
if(zzNewEsi==true){
document.write('<script language="javascript" src="http://d7.zedo.com/OzoDB/cutils/R52_5/jsc/929//egc.js?&x=0&n='+zce0+'&f='+zcx3+'&d='+zcr0+'&z='+Math.random()+'"></script>');
}else{
...
zce8.src='http://r1.zedo.com/log/ERR.gif?v=OzoDB/cutils/R52_5/jsc/929/;'+zcp3+'b='+navigator.userAgent;
}}
function zCU0(){
var zcq5=new Date();
