...
// if s_account var is not set yet, set it to our dev space
// otherwise, it should have already been set before including this file
if (typeof s_account == 'undefined') {
    var s_account = "msnportalmobilemarketplacedev"; // The portal default dev space.
}
...
//s.trackDownloadLinks = true; // set in the page
s.trackExternalLinks = true
s.trackInlineStats = true
//s.linkDownloadFileTypes = "exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls"; // set in the page
...
s.visitorNamespace = "microsoftxna"
s.trackingServer = "microsoftxna.112.2o7.net"
